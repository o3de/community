...
4. **PR Stage** 
    ...
    1. **Markdown Design**
        In order for the blog to render properly (show on the website in the proper format), it is required that you follow a few steps. Blogs must be written using the Markdown language and saved as a `.md` file. The [Markdown guide](/process-docs-and-markdown/files/website-markdown.md) includes templates, examples and code that can be used to help draft the blogs in Markdown. To view how this would look, refer to step 4 part 5, **Testing how the blog displays**. [Templates and Examples](/process-docs-and-markdown/files/)
